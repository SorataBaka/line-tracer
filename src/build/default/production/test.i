...
int main(int argc, char** argv) {
    ...
    while(1){
        if(!PORTAbits.RA0){
            ...
            {PORTBbits.RB6=0;}
            {int t;for(t=0;t<(400 -100)*10;t+=758/100*2){PORTAbits.RA6=1;_delay((unsigned long)((758)*(4000000/4000000.0)));PORTAbits.RA6=0;_delay((unsigned long)((758)*(4000000/4000000.0)));}_delay((unsigned long)((100)*(4000000/4000.0)));};
        } else {PORTBbits.RB6=1;}

        if(!PORTAbits.RA1){

            {PORTBbits.RB4=0;}
            {int t;for(t=0;t<(400 -100)*10;t+=956/100*2){PORTAbits.RA6=1;_delay((unsigned long)((956)*(4000000/4000000.0)));PORTAbits.RA6=0;_delay((unsigned long)((956)*(4000000/4000000.0)));}_delay((unsigned long)((100)*(4000000/4000.0)));};
        } else {PORTBbits.RB4=1;}

        if(!PORTAbits.RA2){

            {PORTBbits.RB5=0;}
            {int t;for(t=0;t<(400 -100)*10;t+=851/100*2){PORTAbits.RA6=1;_delay((unsigned long)((851)*(4000000/4000000.0)));PORTAbits.RA6=0;_delay((unsigned long)((851)*(4000000/4000000.0)));}_delay((unsigned long)((100)*(4000000/4000.0)));};
        } else {PORTBbits.RB5=1;}

        if(!PORTAbits.RA3){

            {PORTBbits.RB7=0;}
            {int t;for(t=0;t<(600 -100)*10;t+=716/100*2){PORTAbits.RA6=1;_delay((unsigned long)((716)*(4000000/4000000.0)));PORTAbits.RA6=0;_delay((unsigned long)((716)*(4000000/4000000.0)));}_delay((unsigned long)((100)*(4000000/4000.0)));};
