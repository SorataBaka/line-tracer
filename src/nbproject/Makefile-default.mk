...
SOURCEFILES_QUOTED_IF_SPACED=buz.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/buz.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/buz.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/buz.p1
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/buz.p1: buz.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/buz.p1.d 
	@${RM} ${OBJECTDIR}/buz.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/buz.p1 buz.c 
	@-${MV} ${OBJECTDIR}/buz.d ${OBJECTDIR}/buz.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/buz.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
